...
namespace Smooth
{
    ...
    public class State
    {
        ...
        /// </summary>
        public State copyFromState(State state)
        {
        ...
        /// <returns></returns>
        public static State Lerp(State targetTempState, State start, State end, float t)
        {
        ...
        {
            ownerTimestamp = smoothSyncScript.currentLocalTime;
    ...
    public class NetworkState : MessageBase
    {
        ...
        override public void Deserialize(NetworkReader reader)
        {
            ...
            // Find the GameObject
            GameObject ob = null;
            if (NetworkServer.active && netID != NetworkInstanceId.Invalid)
            {
                ob = NetworkServer.FindLocalObject(netID);
            }
            else if (netID != NetworkInstanceId.Invalid)
            {
